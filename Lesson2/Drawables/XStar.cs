...
namespace Lesson2.Drawables
{
    public class XStar : GameObjects
    {
        ...
        {
            graphics.DrawLine(Pens.White, _position.X, _position.Y, _position.X + _size.Width, _position.Y + _size.Height);
            graphics.DrawLine(Pens.White, _position.X + _size.Width, _position.Y, _position.X, _position.Y + _size.Height);
        }
